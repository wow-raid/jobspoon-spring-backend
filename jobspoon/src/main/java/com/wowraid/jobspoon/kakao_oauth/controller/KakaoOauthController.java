...
import com.wowraid.jobspoon.kakao_oauth.controller.request_form.KakaoOauthAccessTokenRequest;
...
public class KakaoOauthController {
    ...
    public ResponseEntity<Map<String, String>> getLoginLink() {
    ...
    //kakao 연동 해제 요청
    @GetMapping("/unlink")
    public ResponseEntity<Map<String, String>> unlink(@RequestHeader("Authorization") String bearerToken) {
